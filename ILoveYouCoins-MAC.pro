...
RESOURCES += src/qt/iloveyoucoins.qrc
...
# also add new translations to src/qt/iloveyoucoins.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/iloveyoucoins_*.ts)
...
macx:ICON = src/qt/res/icons/iloveyoucoins.icns
